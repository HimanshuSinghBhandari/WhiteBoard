  ...
  return (
    <div className="flex items-center justify-center align-center min-h-screen">
      ...
      <motion.div
        ...
        className="relative z-10 px-8 py-6 mt-24 text-left bg-white shadow-lg rounded-lg max-w-md w-80"
      >
        ...
        >
          Don't want to sign up yet? <Link to="/signup" className="font-bold text-black hover:underline">Sign up</Link>
        </motion.p>
      </motion.div>
